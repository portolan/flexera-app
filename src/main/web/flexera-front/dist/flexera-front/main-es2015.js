...
/* harmony default export */ __webpack_exports__["default"] = ("<app-people-list></app-people-list>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<mat-toolbar>\n    <span>Flexera App - Matheus</span>\n</mat-toolbar>\n\n<mat-table [dataSource]=\"dataSourceTab\" class=\"mat-elevation-z8\">\n\n    <ng-container matColumnDef=\"flag\">\n        <mat-header-cell *matHeaderCellDef style=\"max-width: 50px\">  </mat-header-cell>\n        <mat-cell style=\"max-width: 50px\" *matCellDef=\"let element\">\n            <mat-checkbox (change)=\"$event ? changeFlag(element) : null\" \n                          [(ngModel)]=\"element.flag\"></mat-checkbox>\n        </mat-cell>\n    </ng-container>\n\n    <ng-container matColumnDef=\"name\">\n      <mat-header-cell *matHeaderCellDef> Name </mat-header-cell>\n      <mat-cell *matCellDef=\"let element\"> {{element.name}} </mat-cell>\n    </ng-container>\n  \n    <ng-container matColumnDef=\"age\">\n      <mat-header-cell *matHeaderCellDef> Age </mat-header-cell>\n      <mat-cell *matCellDef=\"let element\"> {{element.age}} </mat-cell>\n    </ng-container>\n  \n    <ng-container matColumnDef=\"balance\">\n      <mat-header-cell *matHeaderCellDef> Balance </mat-header-cell>\n      <mat-cell *matCellDef=\"let element\"> £ {{ element.balance | number: '1.2-2' }} </mat-cell>\n    </ng-container>\n  \n    <ng-container matColumnDef=\"address\">\n      <mat-header-cell *matHeaderCellDef> Address </mat-header-cell>\n      <mat-cell *matCellDef=\"let element\"> {{element.address}} </mat-cell>\n    </ng-container>\n\n\n    <ng-container matColumnDef=\"email\">\n        <mat-header-cell *matHeaderCellDef> Email </mat-header-cell>\n        <mat-cell *matCellDef=\"let element\"> {{element.email}} </mat-cell>\n    </ng-container>\n  \n    <mat-header-row *matHeaderRowDef=\"displayedColumns\"></mat-header-row>\n    <mat-row *matRowDef=\"let row; columns: displayedColumns;\"></mat-row>\n\n    \n  </mat-table>\n  <mat-paginator [pageSizeOptions]=\"[5, 10, 20]\" [pageSize]=\"5\" showFirstLastButtons></mat-paginator>");
...
/* harmony import */ var _people_list_people_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./people-list/people-list.component */ "./src/app/people-list/people-list.component.ts");
...
/* harmony import */ var _people_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./people.service */ "./src/app/people.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _people_list_people_list_component__WEBPACK_IMPORTED_MODULE_6__["PeopleListComponent"]
        ],
        imports: [
        ...
        providers: [_people_service__WEBPACK_IMPORTED_MODULE_10__["PeopleService"]],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Blb3BsZS1saXN0L3Blb3BsZS1saXN0LmNvbXBvbmVudC5jc3MifQ== */");
...
let PeopleListComponent = class PeopleListComponent {
    constructor(peopleService) {
        ...
        this.displayedColumns = ['flag', 'name', 'age', 'balance', 'email', 'address'];
    }
    ngOnInit() {
        this.peopleService.getPeople().subscribe((data) => {
            this.dataSourceTab = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](data);
...
let PeopleService = class PeopleService {
    constructor(http) {
        this.http = http;
        this.peopleUrl = 'http://localhost:8080/people';
    }
    getPeople() {
...
module.exports = __webpack_require__(/*! D:\Pasta Imp\Projetos\flexera\app\src\main\web\flexera-front\src\main.ts */"./src/main.ts");
